              ...
              >
                <div className="row gy-4 list-grid-wrapper">
                  <div className="col-xl-4 col-sm-6">
                    <div className="product-item section-bg">
                      <div className="product-item__thumb d-flex">
                        <Link scroll={false} href={`/product-details?img=${encodeURIComponent("assets/images/thumbs/product-img1.png")}`} className="link w-100">
                      ...
                      <div className="product-item__content">
                        ...
                        <div className="product-item__info flx-between gap-2">
                          <span className="product-item__author">
                            by
                            <Link scroll={false} href="/profile" className="link hover-text-decoration-underline">
                              themepix
                            </Link>
                          </span>
                          <div className="flx-align gap-2">
                            <h6 className="product-item__price mb-0">$100</h6>
                            <span className="product-item__prevPrice text-decoration-line-through">$130</span>
                          </div>
                        </div>
                        <div className="product-item__bottom flx-between gap-2">
                          <div>
                            <span className="product-item__sales font-14 mb-2">100 Sales</span>
                          ...
                          <Link scroll={false} href="/product-details" className="btn btn-outline-light btn-sm pill">
                            Live Demo
                          </Link>
                        </div>
                      </div>
                  ...
                  <div className="col-xl-4 col-sm-6">
                    <div className="product-item section-bg">
                      <div className="product-item__thumb d-flex">
                        <Link scroll={false} href={`/product-details?img=${encodeURIComponent("assets/images/thumbs/product-img2.png")}`} className="link w-100">
                          <img src="assets/images/thumbs/product-img2.png" alt="" className="cover-img" />
                        </Link>
                        <button type="button" className="product-item__wishlist">
                          <i className="fas fa-heart" />
                        </button>
                      ...
                      <div className="product-item__content">
                        ...
                        <div className="product-item__info flx-between gap-2">
                          ...
                          <div className="flx-align gap-2">
                            <h6 className="product-item__price mb-0">$110</h6>
                            <span className="product-item__prevPrice text-decoration-line-through">$140</span>
                          </div>
                        </div>
                        <div className="product-item__bottom flx-between gap-2">
                          <div>
                            <span className="product-item__sales font-14 mb-2">200 Sales</span>
                            <div className="d-flex align-items-center gap-1">
                              <ul className="star-rating">
                                <li className="star-rating__item font-11">
                                  <i className="fas fa-star" />
                  ...
                  <div className="col-xl-4 col-sm-6">
                    <div className="product-item section-bg">
                      <div className="product-item__thumb d-flex">
                        <Link scroll={false} href={`/product-details?img=${encodeURIComponent("assets/images/thumbs/product-img3.png")}`} className="link w-100">
                          <img src="assets/images/thumbs/product-img3.png" alt="" className="cover-img" />
                        </Link>
                        <button type="button" className="product-item__wishlist">
                          <i className="fas fa-heart" />
                        </button>
                      ...
                      <div className="product-item__content">
                        ...
                        <div className="product-item__info flx-between gap-2">
                          ...
                          <div className="flx-align gap-2">
                            ...
                            <span className="product-item__prevPrice text-decoration-line-through">$150</span>
                          </div>
                        </div>
                        <div className="product-item__bottom flx-between gap-2">
                          <div>
                            <span className="product-item__sales font-14 mb-2">300 Sales</span>
                            <div className="d-flex align-items-center gap-1">
                              <ul className="star-rating">
                                <li className="star-rating__item font-11">
                                  <i className="fas fa-star" />
